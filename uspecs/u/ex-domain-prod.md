...
- 🎯softeng -> |supplier-customer| 🎯conf
  - Instructions how to implement particular task
...
- 🎯conf -> |supplier-customer| 👤Engineer
  - Installation
- ⚙️AI Agent -> |supplier-customer| 🎯conf
...
- 🎯softeng -> |supplier-customer| 👤Engineer
