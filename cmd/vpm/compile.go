...
// compile compiles voedger application in dir and collect all the files that belong to the application
func compile(workingDir string) (packageFiles, error) {
	...
	return pkgFiles, errors.Join(errs...)
}
