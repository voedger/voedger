...
func alertRemoveDiscord(cmd *cobra.Command, _ []string) error {
	currentCmd = cmd
	cluster := newCluster()
...
func alertConfigsDownload(cmd *cobra.Command, _ []string) error {
	currentCmd = cmd
	cluster := newCluster()
...
func alertConfigsUpload(cmd *cobra.Command, _ []string) error {
	currentCmd = cmd
	cluster := newCluster()
