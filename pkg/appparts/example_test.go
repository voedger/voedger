...
func Example() {
	...
	appParts.DeployApp(istructs.AppQName_test1_app1, nil, app_1_v1, 1, appparts.PoolSize(2, 2, 2))
	appParts.DeployApp(istructs.AppQName_test1_app2, nil, app_2_v1, 1, appparts.PoolSize(2, 2, 2))
