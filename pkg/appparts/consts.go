...
var NullSyncActualizerFactory = func(istructs.IAppStructs, istructs.PartitionID) pipeline.ISyncOperator {
	return &pipeline.NOOP{}
}

// NullExtensionEngineFactories should be used in test only
var NullExtensionEngineFactories = iextengine.ExtensionEngineFactories{
...
var NullActualizerRunner = nullActualizerRunner{}

// NullSchedulerRunner should be used in test only
var NullSchedulerRunner = nullSchedulerRunner{}
