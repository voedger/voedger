...
func ProvideCluster(vvmCtx context.Context, vvmConfig *VVMConfig, vvmIdx VVMIdxType) (*VVM, func(), error) {
	...
	filledAppConfigsType := provideFilledAppConfigsType(appConfigsType, v4)
	extensionEngineFactories := iextengineimpl.ProvideExtEngineFactories(filledAppConfigsType)
