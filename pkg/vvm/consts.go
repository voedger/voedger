...
const (
	DefaultNumCommandProcessors          coreutils.NumCommandProcessors = 10
	DefaultNumQueryProcessors            coreutils.NumQueryProcessors   = 10  // <=0 -> 1 query processor will exist anyway
