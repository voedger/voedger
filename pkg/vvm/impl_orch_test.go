...
func TestBasic(t *testing.T) {
	t.Run("VVMStartAndStop", func(t *testing.T) {
		...
		// Launch VVM1
		problemCtx := vvm1.Launch(DefaultLeadershipDuration, DefaultLeadershipAcquisitionDuration)
	...
	t.Run("LeadershipCollision", func(t *testing.T) {
		...
		// Launch VVM1
		problemCtx1 := vvm1.Launch(DefaultLeadershipDuration, DefaultLeadershipAcquisitionDuration)
		...
		go func() {
			...
			problemCtx2 := vvm2.Launch(DefaultLeadershipDuration, LeadershipAcquisitionDuration(time.Second))
...
func TestAutomaticShutdownOnLeadershipLost(t *testing.T) {
	...
	// Bump mock time
	coreutils.MockTime.Sleep(time.Duration(DefaultLeadershipDuration))
...
func TestCancelLeadershipOnManualShutdown(t *testing.T) {
	...
	// Launch VVM1
	problemCtx1 := vvm.Launch(DefaultLeadershipDuration, DefaultLeadershipAcquisitionDuration)
...
func TestServicePipelineStartFailure(t *testing.T) {
	...
	problemCtx := vvm.Launch(DefaultLeadershipDuration, DefaultLeadershipAcquisitionDuration)
	<-problemCtx.Done()
