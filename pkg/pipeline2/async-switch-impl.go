...
type asyncSwitchOperator struct {
	switchLogic ISwitch[IWorkpiece]
	branches    map[string]IAsyncPipeline
	AsyncNOOP
}

func AsyncSwitchOperator(switchLogic ISwitch[IWorkpiece], firstBranch AsyncSwitchOperatorOptionFunc, otherBranches ...AsyncSwitchOperatorOptionFunc) IAsyncOperator {
