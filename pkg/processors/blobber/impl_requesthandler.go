...
func (r *implIRequestHandler) HandleRead(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
...
func (r *implIRequestHandler) HandleRead_V2(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
	okResponseIniter func(headersKeyValue ...string) io.Writer,
...
func (r *implIRequestHandler) HandleReadTemp_V2(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
	okResponseIniter func(headersKeyValue ...string) io.Writer,
...
func (r *implIRequestHandler) handleWrite(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
...
func (r *implIRequestHandler) HandleWrite(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
	...
	return r.handleWrite(requestCtx, appQName, wsid, header, urlQueryValues, okResponseIniter, reader, errorResponder, requestSender, false, appdef.NullQName, "")
}

func (r *implIRequestHandler) HandleWrite_V2(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
	...
	return r.handleWrite(requestCtx, appQName, wsid, header, nil, okResponseIniter, reader, errorResponder, requestSender, true, ownerRecord, ownerRecordField)
}

func (r *implIRequestHandler) HandleWriteTemp_V2(requestCtx context.Context, appQName appdef.AppQName, wsid istructs.WSID, header map[string]string,
	okResponseIniter func(headersKeyValue ...string) io.Writer, reader io.ReadCloser,
	errorResponder ErrorResponder, requestSender bus.IRequestSender) bool {
	return r.handleWrite(requestCtx, appQName, wsid, header, nil, okResponseIniter, reader, errorResponder, requestSender, true,
