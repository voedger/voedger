...
type RowsProcessorFactory func(ctx context.Context, appDef appdef.IAppDef, state istructs.IState,
	params IQueryParams, resultMeta appdef.IType, responder bus.IResponder, metrics IMetrics, errCh chan<- error) (rowsProcessor pipeline.IAsyncPipeline, iResponseSenderGetter func() bus.IStreamingResponseSender)
