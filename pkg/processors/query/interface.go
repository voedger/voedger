...
type RowsProcessorFactory func(ctx context.Context, cache appdef.SchemaCache, state istructs.IState,
	params IQueryParams, resultMeta appdef.Schema, rs IResultSenderClosable, metrics IMetrics) pipeline.IAsyncPipeline
