...
type acl[Resource, Operation any, Role comparable, ResourcePattern, OperationPattern any] struct {
...
// patternedPermission represents a combination of an operation pattern, a resource pattern, and a role.
...
func NewACL[Resource, Operation any, Role comparable, ResourcePattern, OperationPattern any](rm IResourceMatcher[Resource, ResourcePattern], om IOperationMatcher[Operation, OperationPattern]) *acl[Resource, Operation, Role, ResourcePattern, OperationPattern] {
	return &acl[Resource, Operation, Role, ResourcePattern, OperationPattern]{
...
func (a *acl[Resource, Operation, Role, ResourcePattern, OperationPattern]) HasPermission(o Operation, r Resource, role Role) bool {
...
func (b *aclBuilder[Resource, ResourcePattern, Operation, OperationPattern, Role]) Build(rm IResourceMatcher[Resource, ResourcePattern], om IOperationMatcher[Operation, OperationPattern]) IACL[Resource, Operation, Role] {
	newACL := NewACL[Resource, Operation, Role, ResourcePattern, OperationPattern](rm, om)
