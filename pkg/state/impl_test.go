...
var (
	testRecordQName1      = istructs.NewQName("test", "record1")
	testRecordQName2      = istructs.NewQName("test", "record2")
	testRecordQName3      = istructs.NewQName("test", "record3")
	testEvent             = istructs.NewQName("test", "event")
	testViewRecordQName1  = istructs.NewQName("test", "viewRecord1")
	testViewRecordQName2  = istructs.NewQName("test", "viewRecord2")
	testViewRecordPkQName = istructs.NewQName("test", "viewRecordPk")
	testViewRecordCcQName = istructs.NewQName("test", "viewRecordCc")
	testViewRecordVQName  = istructs.NewQName("test", "viewRecordV")
	testStorage           = istructs.NewQName("test", "testStorage")
)
...
func Test_put(t *testing.T) {
	t.Run("Should be ok", func(t *testing.T) {
		...
		put("int32Fld", istructs.DataKind_int32, mrr, mrw)
		put("int64Fld", istructs.DataKind_int64, mrr, mrw)
		put("float32Fld", istructs.DataKind_float32, mrr, mrw)
		put("float64Fld", istructs.DataKind_float64, mrr, mrw)
		put("byteFld", istructs.DataKind_bytes, mrr, mrw)
		put("stringFld", istructs.DataKind_string, mrr, mrw)
		put("qNameFld", istructs.DataKind_QName, mrr, mrw)
		put("boolFld", istructs.DataKind_bool, mrr, mrw)
		put("recordIDFld", istructs.DataKind_RecordID, mrr, mrw)
	...
	t.Run("Should panic when data kind not supported", func(t *testing.T) {
		require.PanicsWithError(t, "illegal state: field - 'notSupported', kind - '12': not supported", func() {
			put("notSupported", istructs.DataKind_FakeLast, nil, nil)
		})
	})
}
...
func Test_getStorageID(t *testing.T) {
	t.Run("Should be ok", func(t *testing.T) {
		tests := []struct {
			...
			expectedStorage istructs.QName
		}{
			{
				name:            "General storage key",
				kb:              newKeyBuilder(RecordsStorage, istructs.NullQName),
				expectedStorage: RecordsStorage,
			},
			{
				name:            "Email storage key",
				kb:              &sendMailStorageKeyBuilder{keyBuilder: newKeyBuilder(SendMailStorage, istructs.NullQName)},
				expectedStorage: SendMailStorage,
			},
			{
				name:            "HTTP storage key",
				kb:              &httpStorageKeyBuilder{keyBuilder: newKeyBuilder(HTTPStorage, istructs.NullQName)},
...
func (s *nilAppStructs) Schemas() istructs.ISchemas         { return nil }
...
func (s *mockAppStructs) Schemas() istructs.ISchemas { return s.Called().Get(0).(istructs.ISchemas) }
...
func (r *mockRecords) GetSingleton(workspace istructs.WSID, qName istructs.QName) (record istructs.IRecord, err error) {
...
func (s *mockSchemas) Schemas(cb func(istructs.QName)) { s.Called(cb) }
...
func (s *mockSchema) Kind() istructs.SchemaKindType {
	return s.Called().Get(0).(istructs.SchemaKindType)
}
func (s *mockSchema) Fields(cb func(fieldName string, kind istructs.DataKindType))    { s.Called(cb) }
func (s *mockSchema) Containers(cb func(containerName string, schema istructs.QName)) { s.Called(cb) }
func (s *mockSchema) QName() istructs.QName                                           { return s.Called().Get(0).(istructs.QName) }

type nilSchema struct{}

func (s *nilSchema) Kind() istructs.SchemaKindType                                { return istructs.SchemaKind_null }
func (s *nilSchema) Fields(func(fieldName string, kind istructs.DataKindType))    {}
func (s *nilSchema) Containers(func(containerName string, schema istructs.QName)) {}
func (s *nilSchema) QName() istructs.QName                                        { return istructs.NullQName }
...
func (r *mockViewRecords) KeyBuilder(view istructs.QName) istructs.IKeyBuilder {
	return r.Called(view).Get(0).(istructs.IKeyBuilder)
}
func (r *mockViewRecords) NewValueBuilder(view istructs.QName) istructs.IValueBuilder {
	return r.Called(view).Get(0).(istructs.IValueBuilder)
}
func (r *mockViewRecords) UpdateValueBuilder(view istructs.QName, existing istructs.IValue) istructs.IValueBuilder {
...
func (r *mockRecord) AsQName(name string) istructs.QName {
	return r.Called(name).Get(0).(istructs.QName)
}
...
func (v *mockValue) AsQName(name string) istructs.QName {
	return v.Called(name).Get(0).(istructs.QName)
}
...
func (s *mockStorage) NewKeyBuilder(entity istructs.QName, existingBuilder istructs.IStateKeyBuilder) istructs.IStateKeyBuilder {
...
func (b *mockKeyBuilder) PutQName(name string, value istructs.QName)       { b.Called(name, value) }
...
func (b *mockValueBuilder) PutQName(name string, value istructs.QName)       { b.Called(name, value) }
...
func (r *mockRowReader) AsQName(name string) istructs.QName {
	return r.Called(name).Get(0).(istructs.QName)
}
...
func (w *mockRowWriter) PutQName(name string, value istructs.QName)       { w.Called(name, value) }
...
func (e *mockWLogEvent) QName() istructs.QName        { return e.Called().Get(0).(istructs.QName) }
...
func (e *mockEventError) QNameFromParams() istructs.QName { return e.Called().Get(0).(istructs.QName) }
