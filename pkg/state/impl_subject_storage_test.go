...
func TestSubjectStorage_BasicUsage(t *testing.T) {
	...
	s := ProvideCommandProcessorStateFactory()(context.Background(), func() istructs.IAppStructs { return &nilAppStructs{} }, SimpleIWorkspaceFunc(&nilIWorkspace{}), nil, nil, nil, nil, func() []iauthnz.Principal { return principals }, tokenFunc, 1, nil)
