...
func ProvideViewNextWSID(appDefBuilder appdef.IAppDefBuilder) {
	projectors.ProvideViewDef(appDefBuilder, ViewQNameNextBaseWSID, func(b appdef.IViewBuilder) {
		b.PartKeyDef().AddField(fldDummy1, appdef.DataKind_int32, true)
		b.ClustColsDef().AddField(fldDummy2, appdef.DataKind_int32, true)
		b.ValueDef().AddField(fldNextBaseWSID, appdef.DataKind_int64, true)
	})
}
