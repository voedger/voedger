...
var (
	...
	typeKindToGlobalDocQNames = map[appdef.TypeKind][]appdef.QName{
		...
		appdef.TypeKind_CDoc:    {istructs.QNameCDoc, istructs.QNameCDoc},
		appdef.TypeKind_WDoc:    {istructs.QNameWDoc, istructs.QNameWDoc},
		appdef.TypeKind_ODoc:    {istructs.QNameODoc, istructs.QNameODoc},
