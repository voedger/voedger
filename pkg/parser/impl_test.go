...
func Test_Refs_NestedTables(t *testing.T) {
	...
	inner1 := adf.Def(appdef.NewQName("pkg1", "inner1"))
...
func Test_Workspace_Defs(t *testing.T) {
	...
	require.Equal(appdef.DefKind_CDoc, ws.Def(appdef.NewQName("pkg1", "table1")).Kind())
	require.Equal(appdef.DefKind_CDoc, ws.Def(appdef.NewQName("pkg1", "table2")).Kind())
	...
	require.Equal(appdef.DefKind_Workspace, wsProfile.Def(appdef.NewQName("pkg1", "MyWorkspace")).Kind())
	require.Nil(wsProfile.Def(appdef.NewQName("pkg1", "MyWorkspace2")))
}
