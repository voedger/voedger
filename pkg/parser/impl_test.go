...
func Test_BasicUsage(t *testing.T) {
	...
	// view
	view := appdef.View(app, appdef.NewQName("main", "XZReports"))
	require.NotNil(view)
...
func Test_Views(t *testing.T) {
	...
	t.Run("record fields", func(t *testing.T) {
		...
		require.NoError(err)
		view := appdef.View(def, appdef.NewQName("pkg", "test"))
		require.NotNil(view)
...
func Test_Views2(t *testing.T) {
...

	{
		...
		v := appdef.View(app, appdef.NewQName("test", "test"))
		require.NotNil(v)
	}
	{
		ast, err := ParseFile("file2.vsql", `APPLICATION test(); WORKSPACE Workspace (
...
func Test_VRestaurantBasic(t *testing.T) {
	...
	// view
	view := appdef.View(app, appdef.NewQName("vrestaurant", "SalesPerDay"))
	require.NotNil(view)
	require.Equal(appdef.TypeKind_ViewRecord, view.Kind())
}
