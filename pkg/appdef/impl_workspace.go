...
func (ws *workspace) addLimit(name QName, flt IFilter, rate QName, comment ...string) {
	_ = newLimit(ws.app, ws, name, flt, rate, comment...)
}
...
func (wb *workspaceBuilder) AddLimit(name QName, flt IFilter, rate QName, comment ...string) {
	wb.workspace.addLimit(name, flt, rate, comment...)
}
