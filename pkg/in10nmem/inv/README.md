...
- v1: timers
- v2: Each Channel has its own chan, notifier goroutine writes to all chans
- v3: Each projection key has an associated value, sigchan is closed when the offset is updated, Watchers use sigchan to wait for the update
```
